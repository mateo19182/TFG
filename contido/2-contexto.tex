...
Entre elas inclúense a fotografía de fondo de ollo (retinografía), a tomografía de coherencia óptica (OCT) e a angiografía con fluoresceína \cite{ilginis2014ophthalmic}.



\subsection{Retinografía}
\label{subsec:Retinografía}
Este traballo céntrase na retinografía entre outras razóns polo seu uso común na práctica clínica.
...
\paragraph{Métodos Supervisados}
\label{paragraph:Métodos Supervisados}
...
\paragraph{Métodos Non Supervisados}
\label{paragraph:Métodos Non Supervisados}
...
O rexistro mediante landmarks segue a ser moi usado neste contexto, e desenrroláronse múltiple metodoloxías específicas.

\cite{piifd}, \cite{GDB-ICP}  co obxetivo de mellorar o recoñecemento de puntos característicos en retinas.

\cite{rempe} propoñen a estimación simultánea da pose das cámaras que adquiriron as imaxes e da forma e pose do ollo. Utiliza un modelo elipsoidal para u ollo e a pose das cámaras estímase mediante RANSAC, seguido de una variante de \gls{PSO} \cite{pso}. 
