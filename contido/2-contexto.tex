...
Neste traballo escollemos a segunda opción, utilizando unha función de activación periódica para obter un modelo de tipo SIREN, σ(x) = sin(ax+b) with a, b ∈ R.
...
\begin{itemize}
    ...
    αl, αa y αν son hiperparámetros que controlan a importancia de cada término.
...
A aportación clave que realiza \cite{wolterink2021implicit} é que a transformación Φ está implícitamente representada na rede neuronal.
