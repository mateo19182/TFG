...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Difeomórfica:} Unha transformación non ríxida que é continua, invertible e diferenciable en todo o seu dominio.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textit{Asimétrico:} A transformación calcúlase só nun sentido (de móbil a fixa).
    \end{itemize}
...
Cando se traballa con imaxes de forma asimétrica, a imaxe de referencia denomínase imaxe fixa e a imaxe que se quere rexistrar imaxe móbil.
Segundo o tipo de transformación utilizada esta pode ser clasificada en ríxida, afín ou deformable.

As transformacións podense representar en matrices, onde cada elemento da matriz representa un parámetro da transformación.
...
Se non tén esta característica, non se pode garantir que a transformación sexa reversíbel, polo que son preferidas en moitos casos \cite{han2022diffeomorphicimageregistrationneural}, 
...
Unha vantaxe deste enfoque é a capacidade para rexistrar imaxes con grandes variacións locais ou modalidades diferentes.
...
\paragraph{Sustitución de módulos en rexistro baseado en imaxes (IBR)}
\label{par:IBR_substitution}

Os métodos de rexistro tradicionais teñen tres compoñentes principais: a métrica de similitude, o optimizador e o modelo de transformación. Os métodos de aprendizaxe profunda poden substituír calquera destes módulos de forma independente ou en combinación.
...
\paragraph{Sustitución de módulos en rexistro baseado en características (FBR)}
\label{par:FBR_substitution}

Os métodos de rexistro baseado en características dependen de tres etapas secuenciais: detección de características, descrición de características e emparellamento. Os métodos de aprendizaxe profunda poden substituír cada un destes módulos de forma independente ou en combinación.
...
% mergear lo de abajo en lo de arriba-
...
\subsubsection{Aplicación en retinas}
\label{subsec:Aplicación en retinas}

Os métodos que funcionan ben en varios dominios de imaxe médica (cerebro, pulmóns, etc) 
...
O rexistro mediante landmarks segue a ser moi usado neste contexto, e hay especial interese por métodos moi robustos que permitan
 ...
 Na figura \ref{fig:retin_reg} móstrase un exemplo de rexistro de imaxes de retina, onde se pode observar como as estruturas anatómicas da retina son aliñadas entre si.


------  meter arriba con el resto de cosas
...
A pesar do potencial das representaciones neuronales implícitas en diversos dominios médicos, a súa aplicación específica ao rexistro de retinografías permanece inexplorada.
