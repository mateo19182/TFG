...
Con esta nova división do dataset, realizouse a avaliación polo método de FIRE, que se pode ver na figuras \ref{fig:FIRERFMID_relu} e \ref{fig:FIRERFMID_SIREN}.
...
\begin{figure}[ht]
    ...
    \end{subfigure}
    \caption{Métricas dataset FIRE co dataset RFMID}
    \label{fig:FIRERFMID_scores}
\end{figure}


Nas figuras \ref{fig:batch_size_comparison_relu} e \ref{fig:batch_size_comparison_siren} pódense observar os resultados da experimentación.
...
\begin{figure}[ht]
    ...
    \label{fig:batch_size_comparisons}
\end{figure}
