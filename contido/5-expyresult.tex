...
\ref{tab:initialization_phase_results_RFMID}, \ref{tab:initialization_phase_results_FIRE}, \ref{tab:initialization_lottery_results_RFMID}, \ref{tab:initialization_lottery_results_FIRE}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|c|c|}
    \hline
    Network Type & N-Phases & Mean Distance \\ \hline
    MLP & 1 & 99.73 \\ \hline
    MLP & 2 & 144.88 \\ \hline
    MLP & 3 & 307.01 \\ \hline
    SIREN & 1 & 80.69 \\ \hline
    ...
    SIREN & 3 & 75.76 \\ \hline
    \end{tabular}
    \caption{Distancia media segundo o número de fases, para ambos tipos de rede, co dataset FIRE}
    \label{tab:initialization_phase_results_FIRE}
\end{table}
...
\begin{table}[ht]
    ...
    MLP & 3 & 122.94 \\ \hline
    SIREN & 1 & 66.95 \\ \hline
    SIREN & 2 & 133.85 \\ \hline
    SIREN & 3 & 176.36 \\ \hline
    \end{tabular}
    \caption{Distancia media segundo o número de fases, para ambos tipos de rede, co dataset RFMID}
    \label{tab:initialization_phase_results_RFMID}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|c|c|}
    \hline
    Network Type & lottery & Mean Distance \\ \hline
    Relu & 1 & 97.20 \\ \hline
    Relu & 5 & 94.35 \\ \hline
    Relu & 25 & 98.18 \\ \hline
    SIREN & 1 & 66.08 \\ \hline
    SIREN & 5 & 58.71 \\ \hline
    SIREN & 25 & 64.45 \\ \hline
    \end{tabular}
    \caption{Distancia media segundo o número de lotería, para ambos tipos de rede, co dataset FIRE}
    \label{tab:initialization_lottery_results_FIRE}
\end{table}
...
\begin{table}[ht]
    ...
    \begin{tabular}{|l|c|c|}
    \hline
    Network Type & Loss Function & Mean Distance \\ \hline
    Relu & 1 & 31.42 \\ \hline
    Relu & 5 & 31.45 \\ \hline
    Relu & 25 & 30.16 \\ \hline
    SIREN & 1 & 64.74 \\ \hline
    SIREN & 5 & 61.49 \\ \hline
    SIREN & 25 & 60.95 \\ \hline
    \end{tabular}
    \caption{Distancia media segundo o número de lotería, para ambos tipos de rede, co dataset RFMID}
    \label{tab:initialization_lottery_results_RFMID}
\end{table}
