...
Ao ser un proxecto de investigación, a metodoloxía de traballo máis adecuada é unha metodoloxía iterativa e incremental, que permite adaptarse aos cambios que van xurdindo durante o desenvolvemento do proxecto.
...
\begin{tabular}{|c|c|c|}
\hline
\textbf{Característica} & \textbf{Servidor Persoal} & \textbf{Servidor VARPA} \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{FIRE:} 134 pares de imaxes de retinas en cor, cun tamaño de 2912×2912 píxeles
\end{itemize}
...
Pese a que nas fases iniciais do proxecto se respectou a planificación, a fase de adaptación ao novo dominio e a fase de avaliación e experimentación sufriron atrasos significativos.
...
A estimación de custo do proxecto foi de 20.680€, como se indicou na sección \ref{subsec:Estimación de custos}. Non obstante, debido aos atrasos no desenvolvemento do proxecto, o custo real aumentou de forma proporcional ao tempo extra empregado.
