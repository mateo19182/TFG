...
Por cada época de entrenamento (2500 en total), 10000 puntos son muestreados aleatoriamente do espazo de coordenadas dentro da máscara.
...
Debido á natureza da rede, o tamaño de lote utilzado ten unha relación directa co learning rate, polo que tentaremos determinar a relación óptima entre ambos.

Unha das heurísiticas mais comúns para relacionar o learning rate e o tamaño de lote é a regla de escalado linear \cite{goyal2018accuratelargeminibatchsgd}. 
...
O custo temporal e de memoria dependen de varios factores, sendo os mais relevantes a regularización empregada, a resolución da imaxe, o tamaño do tamaño de lote e a función de activación.
