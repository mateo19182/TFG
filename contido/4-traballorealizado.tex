...
\begin{figure}[ht]
    ...
    \caption{Exemplos de avaliación visual: (a) Composición de imaxes antes e despois do rexistro, (b) Visualización dos vectores de desprazamento, (c) Comparación directa das imaxes rexistradas.}
    \label{fig:visex}
\end{figure}