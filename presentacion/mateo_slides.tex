...
%             \item Tamaño do lote (\textit{batch size}).
%         \end{itemize}
...
\begin{frame}
    ...
    % - "Estas gráficas mostran o rendemento no dataset real. A liña laranxa, cun batch size de 10.000, está moi por riba das outras."
