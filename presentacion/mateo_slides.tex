...
\begin{frame}
    ...
    % NOTAS PARA O PRESENTADOR:
    % - Comeza explicando a imaxe da dereita. "O noso obxectivo é tomar unha imaxe 'móbil' e deformala para que se aliñe perfectamente cunha imaxe 'fixa', como vemos no resultado superposto".
    % - A continuación, expón a necesidade clínica. "Por que é isto importante? Porque permite aos médicos comparar imaxes tomadas en diferentes momentos para ver como avanza unha enfermidade, por exemplo, o glaucoma ou a retinopatía diabética".
    % - Subliña a importancia do ollo como ferramenta de diagnóstico: "O fondo do ollo é un dos poucos lugares onde podemos ver directamente os vasos sanguíneos e o tecido neuronal, o que nos dá pistas sobre enfermidades sistémicas".
    % - Finalmente, presenta o problema que o teu traballo resolve: "O problema é que facer isto a man é lento, difícil e subxectivo. A nosa meta é automatizar este proceso para facelo máis rápido, obxectivo e escalable, liberando o tempo dos especialistas para tarefas de maior valor clínico".
\end{frame}
...
\begin{frame}
    ...
    % NOTAS PARA O PRESENTADOR:
    % - Presenta os obxectivos de forma clara e estruturada. Isto demostra que o traballo ten un plan de investigación sólido.
    % - Obxectivo 1: "O noso punto de partida é un método recente e prometedor chamado IDIR, pero que foi deseñado para imaxes 3D. O noso primeiro obxectivo foi un traballo de enxeñaría: adaptalo ao noso problema de imaxes 2D de retina."
    % - Obxectivo 2: "Unha vez adaptado, tiñamos que probalo rigorosamente. Para iso, usamos dous datasets. RFMID, que é sintético, permítenos medir a precisión xeométrica do modelo en condicións ideais. FIRE, con imaxes reais, pon a proba a súa robustez ante os desafíos clínicos." Isto mostra un bo deseño experimental.
    % - Obxectivo 3: "Finalmente, o obxectivo máis científico. Queriamos investigar unha hipótese clave: se unha arquitectura específica, chamada SIREN, que ten propiedades teóricas interesantes, podería superar as limitacións das redes estándar para esta tarefa tan detallada."
    % - Conclúe: "En resumo: adaptamos, probamos e investigamos unha hipótese central."
\end{frame}
