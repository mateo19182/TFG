...
\begin{block}{Estratexias actuais en rexistro con redes neuronais}
    \begin{itemize}
        ...
        % \item \textbf{Tendencia actual}: Métodos híbridos que combinan deep learning e algoritmos clásicos para precisión e velocidade.
    \end{itemize}
\end{block}
...
\begin{alertblock}{Contribución}
    % Rexistro de retinografías é difícil por deformacións non ríxidas, baixo solapamento e variacións de anatomía.\\
...
% NOTAS PARA O PRESENTADOR:
% - Resume as estratexias actuais e destaca a novidade do enfoque INR.
% - O rexistro de retina require solucións robustas; o noso método explora unha vía ata agora non estudada
\end{frame}
...
\vspace{0.2cm}
% \footnotesize
% SIREN permite calcular derivadas de orde superior de forma eficiente, facendo posible esta regularización avanzada.
\end{frame}
